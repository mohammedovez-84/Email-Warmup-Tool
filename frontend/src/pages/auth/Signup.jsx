...
const Signup = () => {
  ...
  const handleGoogleSignup = () => {
    ...
    const googleAuthUrl = `/api/auth/google?redirect=${encodeURIComponent(redirectUrl)}&signup=true`;
              ...
              <form onSubmit={handleSubmit} className="space-y-5 flex-grow flex flex-col">
                ...
                <div className="mt-auto pt-4">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-white text-gray-700 py-3 px-4 rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-3 border border-gray-300 hover:border-gray-400"
                    whileHover={{ scale: 1.01 }}
                    whileTap={{ scale: 0.99 }}
                  >
